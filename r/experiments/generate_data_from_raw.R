...
saveRDS(tcga_expression, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/tcga_expression_", cancer, ".RData"))
rm(list=ls())
###
# GTEx Data
###
...
saveRDS(GTEx_expression, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/GTEx_", cancer, ".RData"))
rm(list=ls())
###
# Mutation Alteration
###
...
saveRDS(data.mut, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/mutex_alt_", cancer, ".RData"))
rm(list=ls())
###
...
saveRDS(events, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/discover_event_matrix_", cancer, ".RData")) 
rm(list=ls())
###
# DiscoverSL
### 
...
saveRDS(discoversl_mut, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/discoversl_mutex_", cancer, ".RData")) 
rm(list=ls())
###
# MUTEX
###
...
ranked_groups <- read_delim("~/repos/SBSL-modelling-and-analysis/tmp/ranked-groups.txt", 
                              ...
                              trim_ws = TRUE, skip = 1)
saveRDS(ranked_groups, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/MUTEX_", cancer, ".RData"))
rm(list=ls())
###
# TCGA Survival
###
clinical <- read_delim(paste0("~/repos/SBSL-modelling-and-analysis/raw_data/firehose/20160128-", cancer, "-Clinical.txt"), 
                       "\t", escape_double = FALSE, trim_ws = TRUE)
...
saveRDS(alt_me, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/clinical_mutation_", cancer, ".RData"))
saveRDS(under_me, paste0("~/repos/SBSL-modelling-and-analysis/r/data/datasets/clinical_underexpressed_mRNA_", cancer, ".RData"))
rm(list=ls())